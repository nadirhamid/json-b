dll:
	...
	"${JAVA_HOME}/bin/javac.exe" -d "java/classes" -classpath "java/classes" "java/src/com/jsonb/ExecJar/JSONBExample.java" "java/src/com/jsonb/ExecJar/TestExample.java" "java/src/com/jsonb/ExecJar/Reflection.java"
nodll:
...
run:
	cd ./java/
	"${JAVA_HOME}/bin/java.exe" -classpath "java/classes" com.jsonb.ExecJar.TestExample
